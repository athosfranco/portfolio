...
import walletMockup from "./img/wallet_mockup.png";
...
export const data = {
  about: {
    pt: `Olá! Meu nome é Athos Franco. Tenho 27 anos e sou um Desenvolvedor Web Fullstack. Minhas principais linguagens são TypeScript e Java. Utilizo tecnologias modernas existentes em ambas linguagens para desenvolver soluções para web.`,
    en: `Hi! My name is Athos Franco. I'm a 27 years old Fullstack Web Dev. My main languages are Java and TypeScript. I use modern technologies existing in both languages ​​to develop great solutions for the web.`,

    resumeUrl:
      "https://drive.google.com/file/d/1FP5HSgZIgJ8A5Btmlt9WWOFVti4WtEnO/view?usp=sharing",
    resumeUrlEnglish:
      "https://drive.google.com/file/d/1DqfPflXd284LbvN8BPh7zHmGdS-VIlTz/view?usp=sharing",
  },
  skills: [
    "React",
    "Angular",
    "TypeScript",
    "Styled Components/Bootstrap/MUI",
    "NodeJs",
    "Java",
    "Spring Boot",
    "Spring Data JPA",
  ...
  projects: [
    {
      id: 1,
      title: `Wallet`,
      desc: `Sistema de Gestão Financeira apresentado como Projeto Final para o Bootcamp Dev For Tech. Se trata de uma Aplicação Web Fullstack responsiva que organiza e facilita o controle das finanças pessoais através de um dashboard intuitivo, com gráficos e relatórios em PDF.\n\nLogin: demo@mywallet.com / senha: 123321`,
      descEn: `Financial Management System presented as Final Project for Bootcamp Dev For Tech. It is a responsive Fullstack Web Application that organizes and facilitates the control of personal finances through an intuitive dashboard, with graphs and PDF reports.`,
      stack: [
        "React",
        "TypeScript",
        "Styled Components",
      ...
      url: "https://myvallet.vercel.app/",
      rep: "https://github.com/athosfranco/project-devfortech",
      img: walletMockup,
    },
    {
      id: 2,
